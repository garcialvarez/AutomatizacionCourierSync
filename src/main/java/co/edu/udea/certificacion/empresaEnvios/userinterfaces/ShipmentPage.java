...
public class ShipmentPage extends PageObject {
    ...
    public static final Target OPTION_ORIGEN = Target.the("Opción de origen").locatedBy("//*[@data-radix-portal]//*[contains(normalize-space(),'{0}')]");
    ...
    public static final Target OPTION_DESTINO = Target.the("Opción de destino").locatedBy("//div[contains(normalize-space(),'Andes')]");
    ...
    public static final Target SHIPMENT_CREATED = Target.the("Msg envio creado creado").locatedBy("//*[@id=\"root\"]/div[1]/ol/li/div/div[1]");
    public static final Target TOAST_MESSAGE = Target.the("Toast message").locatedBy("//*[contains(translate(text(),'ÁÉÍÓÚáéíóú','AEIOUaeiou'),'Envio') or contains(translate(text(),'ÁÉÍÓÚáéíóú','AEIOUaeiou'),'Creado')]");
    public static final Target PRESS_DELETE_BUTTON = Target.the("Press delete button").locatedBy("//*[@id=\"root\"]/div[2]/main/div/div[2]/div/div/table/tbody/tr[3]/td[7]/div/button[3]");
